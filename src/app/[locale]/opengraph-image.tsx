...
// Pre-render one OG image per supported locale at build time.
...
export const alt = "AICareerPivot";
...
export default async function Image({
  ...
  // Everything drawn on the canvas, so the subset covers every glyph.
