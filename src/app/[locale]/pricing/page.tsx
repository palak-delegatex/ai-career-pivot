  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <main id="main-content" className="max-w-6xl mx-auto px-6 py-16">
        ...
        {/* Value-framing cards (AIC-893) — replace the removed fabricated
            testimonial cards with what you actually get, no invented people or
            outcome numbers. */}
        <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-6">
          {[
            {
              title: "What you get",
              body: "A personalized AI-pivot roadmap with 6-month, 1-year, and 2-year milestones built from your own skills and constraints — not generic advice.",
            },
            {
              title: "How it's built",
              body: "Generated by Claude and grounded in real labor-market data (U.S. Bureau of Labor Statistics salary and growth figures), so the plan reflects the actual market.",
            },
            {
              title: "Why now",
              body: "We're newly launched — get in early. One-time payment, no subscription, and a 30-day money-back guarantee if it isn't useful.",
            },
          ].map((c) => (
            <div key={c.title} className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
        ...
        {/* Verifiable credibility signals — what the plan is built on (AIC-893) */}
        <div className="max-w-4xl mx-auto mb-10">
