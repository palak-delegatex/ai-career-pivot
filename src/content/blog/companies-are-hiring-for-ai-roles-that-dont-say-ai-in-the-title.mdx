...
faq:
  - question: "Why can't I find AI jobs when I search for 'AI' in the title?"
    answer: "Because most AI-enabled roles don't put 'AI' in the title. The bigger wave is existing roles — like Marketing Director or Supply Chain Manager — being restructured to require AI-powered analytics or predictive modeling. If you only search for 'AI' or 'machine learning,' you're seeing less than a third of your real opportunities."
  - question: "Do hidden AI roles require an engineering or CS degree?"
    answer: "No. The five categories covered here — AI operations, governance and compliance, AI-augmented domain expert, training and enablement, and strategy and integration — value domain expertise plus AI fluency over coding. Your existing industry knowledge is the qualification; AI fluency is the layer you add on top of it."
  - question: "How much more do workers with AI skills earn?"
    answer: "Workers who combine AI skills with domain expertise earn 62% more than peers without AI skills, per PwC's 2026 AI Jobs Barometer, and the premium reaches 118% in some consumer-facing industries. Companies most exposed to AI are also growing headcount faster than the market — they're creating these blended roles, not cutting them."
  - question: "What can I do this week to find these roles?"
    answer: "Start by rewriting your search terms around AI-adjacent skills — 'predictive analytics,' 'AI-powered,' 'automation' — instead of 'AI' alone. The final section lays out five concrete steps to reposition your existing experience, from auditing job postings in your field to reframing your resume around AI fluency."
---
