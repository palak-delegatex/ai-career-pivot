...
faq:
  - question: "What are transferable skills and why do they matter for career changers?"
    answer: "Transferable skills are capabilities that carry across industries — communication, leadership, analysis, domain knowledge. They matter because they let a new field see you as an asset rather than a risk, and most career changers undercount them by a factor of 3-4x."
  - question: "How do I identify my transferable skills?"
    answer: "Categorize them into three tiers: universal (communication, leadership), adjacent (domain-specific tools and methods), and hidden (industry knowledge you take for granted). Working through all three tiers surfaces far more than an off-the-cuff list."
  - question: "How do I present transferable skills to a new industry?"
    answer: "Reframe them using your target role's language. The same skill described in the new field's terms can be the difference between rejection and an interview — hiring managers respond to relevance, not just capability."
---
