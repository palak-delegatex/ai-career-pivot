...
faq:
  - question: "Can I really work in AI without learning to code?"
    answer: "Yes. The market rewards judgment, ethics, domain expertise, and the ability to translate between technical and business teams — not just coding. The article details five non-technical paths, including AI ethics and governance, AI product management, and AI content strategy, that don't require a computer science degree."
  - question: "Why are companies hiring humanities graduates for AI roles?"
    answer: "Because the hardest part of deploying AI is human, not technical. Firms like BlackRock and McKinsey recruit humanists for judgment, ethical reasoning, and domain understanding. The article notes philosophy majors show lower unemployment than CS grads — a signal that non-technical skills are increasingly the bottleneck in AI adoption."
  - question: "What non-technical AI career paths are available?"
    answer: "The article details five: AI ethics and governance, AI product management, AI content strategy and prompt design, AI training and data annotation, and AI-human collaboration. Each leans on domain expertise and human judgment rather than engineering, making them realistic targets for professionals from non-technical backgrounds."
  - question: "If I don't need to code, what do I actually need to learn?"
    answer: "Some learning is still required — AI literacy, hands-on fluency with tools, and understanding where AI helps or fails in your domain. The article frames the opportunity window in quarters, not years, so pairing your existing 10-plus years of expertise with practical AI fluency now is the move to make."
---
