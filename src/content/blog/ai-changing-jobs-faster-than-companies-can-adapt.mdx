...
faq:
  - question: "Is AI actually going to eliminate my job?"
    answer: "For most professionals, no. BCG's June 2026 research found that 50-55% of US jobs will be reshaped by AI within three years, but only 10-15% will be eliminated. The far more common outcome is that roles evolve into 'professionalized' work where AI handles routine tasks and human judgment becomes more central — which favors mid-career professionals with domain expertise."
  - question: "What is the AI salary premium and is it real?"
    answer: "It's the pay gap between workers with AI skills and peers in the same role without them. PwC's analysis of over 1 billion job postings puts it at 62% today, up from 25% in 2024 and 56% in 2025. The premium is real but expected to normalize as AI literacy becomes standard, so the advantage is largest for those who build fluency now."
  - question: "Do I need to become a data scientist to benefit?"
    answer: "No. The highest-value move is building AI fluency around your existing expertise — understanding where AI fits your specific workflows and evaluating its output with your domain knowledge. You don't need to quit your job or learn to build models to capture most of the upside."
  - question: "Why isn't my company's AI training enough?"
    answer: "BCG found 66% of professionals receive little or no guidance on how to use the time AI saves them, and that people strategy drives roughly 70% of AI's actual value — the part most companies neglect while they buy tools. Waiting for HR to catch up is precisely why individuals who self-direct their AI upskilling pull ahead."
---
