...
faq:
  - question: "Should I be worried about AI taking my job?"
    answer: "Some concern is justified — 186,000 tech workers have been laid off in 2026 so far, with 56% of events citing AI — but only about 9% of companies report AI fully replacing roles. The bigger threat is the slow erosion of your role's value if you don't adapt, not sudden loss."
  - question: "What can I do about AI job risk this week?"
    answer: "Run a 7-day sprint: audit your AI exposure, map your irreplaceable skills, test AI tools in your actual work, and make a clear-eyed decision about your next move. Freezing is the most dangerous response; a small concrete step this week beats a vague plan for 'someday.'"
  - question: "Do I need to learn to code to stay competitive?"
    answer: "No. You don't need to quit, go back to school, or learn to code. Workers who add AI skills to their existing expertise earn about 56% more than peers without them — the leverage is fluency layered on your current domain, not a career restart."
---
