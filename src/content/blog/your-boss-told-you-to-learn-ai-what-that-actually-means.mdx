...
faq:
  - question: "What does my boss actually mean by 'learn AI'?"
    answer: "Usually they mean reach AI fluency, not become an engineer. 'Learn AI' has three layers: literacy (what AI can and can't do), fluency (using AI tools effectively in daily work), and leadership (redesigning workflows). Most mid-career professionals only need to reach fluency — about a 90-day effort, not a degree."
  - question: "How long does it take to learn AI for work?"
    answer: "Roughly 90 days to reach practical fluency, not a two-year degree. The plan maps a schedule: foundation in days 1-14, integration in days 15-45, depth in days 46-75, and visibility in days 76-90. The goal is confident daily use of AI in your role, not technical mastery of how models work."
  - question: "What AI skills matter for my specific role?"
    answer: "It depends on your function, and the guide maps several — marketing, finance, operations, HR, and healthcare administration each get role-specific direction. Rather than a generic course, it points you to the AI use cases that matter in your daily work, so your learning translates directly into results your manager notices."
  - question: "What mistakes should I avoid when told to learn AI?"
    answer: "Five common ones: signing up for a technical course you don't need, treating AI like a search engine, going it alone, waiting for your company to train you, and trying to learn everything at once. Avoiding these keeps you focused on fluency in your actual role instead of wasted effort."
---
