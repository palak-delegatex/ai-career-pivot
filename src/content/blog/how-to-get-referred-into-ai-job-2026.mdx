...
howto:
  steps:
    - name: "List the people who already trust your work"
      text: "Build a list of 15–20 people who have seen you deliver — former managers and colleagues, peers from your field who already moved into AI-adjacent roles, past clients and vendors, and members of any course or professional community. List people who trust you, not people who happen to work in AI."
    - name: "Name the AI-adjacent role your experience points to"
      text: "Decide the specific AI-adjacent role your background supports and the one piece of proof that shows it, so every introduction points the same direction. Specific targets get forwarded; 'anything in AI' does not."
    - name: "Send specific, forwardable asks with an easy off-ramp"
      text: "Each week, message two people with a named target, one line of proof they can forward, and an explicit 'no worries if this isn't a fit.' If nobody is closer to AI than you, ask instead who they know who has moved into AI-adjacent work, to reach a second-degree connection."
    - name: "Run a 20-minute weekly habit and follow the second-order intros"
      text: "Spend 20 minutes a week picking two names, sending two asks, and logging replies. The payoff compounds: each conversation tends to spawn two or three new introductions, so chase those threads instead of waiting on the first message."
tldr:
