...
faq:
  - question: "How do I change careers without hurting my family financially?"
    answer: "Use staged transitions: upskill on nights and weekends, build leverage and proof before moving, and maintain income continuity so you never create a gap. The goal is to pivot without blowing up your household budget or your partner's plans."
  - question: "Can I pivot careers with kids and a mortgage?"
    answer: "Yes, but the plan has to account for those obligations rather than ignore them. That means a longer, lower-risk runway, keeping your current income while you build the new skillset, and validating the target role before committing."
  - question: "How does AICareerPivot help parents changing careers?"
    answer: "It factors your financial obligations and family constraints directly into the plan, producing a staged pivot roadmap designed to protect income continuity — rather than generic advice that assumes you can afford to start over."
---
